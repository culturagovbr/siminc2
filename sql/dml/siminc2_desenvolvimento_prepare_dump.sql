...
-- APAGANDO DE EXECU√á√ÉO OR√áAMENT√ÅRIA DO WEBSERVICE DO SIOP
...
/*
 * Arquivo de RemoÁ„o de dados das tabelas domÌnios do Sistema SIMINC2 - MÛdulo Acompanhamento (Monitoramento).
 *
 * @since 2018/12/05
...
/*
 * Arquivo de RemoÁ„o de dados das tabelas domÌnios do Sistema SIMINC2 - MÛdulo Emendas Parlamentares.
 *
 * @since 2018/12/05
 * @author Douglas Santana <douglas.fontes@cultura.gov.br>
 */
...
/*
 * Arquivo de RemoÁ„o de dados das tabelas domÌnios do Sistema SIMINC2 - MÛdulo Painel (Gest„o EstratÈgica).
 *
 * @since 2018/12/05
 * @author Douglas Santana <douglas.fontes@cultura.gov.br>
 */
...
/*
 * Arquivo de RemoÁ„o de dados das tabelas domÌnios do Sistema SIMINC2 - MÛdulo Planacomorc (Planejamento OrÁament·rio).
 *
 * @since 2018/12/05
 * @author Douglas Santana <douglas.fontes@cultura.gov.br>
 */
...
/*
 * Arquivo de RemoÁ„o de dados das tabelas domÌnios do Sistema SIMINC2 - MÛdulo Proposta OrÁament·ria.
 *
 * @since 2018/12/05
