...
define("AED_ALTERACAO_INTERNO_EM_ANALISE", 4341);
define("AED_ALTERACAO_EXTERNO_EM_ANALISE", 4348);

# Constantes do Wokflow do Alterações Orçamentárias.
define("ESD_EM_CADASTRAMENTO_INTERNO", 1791);
define("ESD_EM_CADASTRAMENTO_EXTERNO", 1798);
define("ESD_AGURADANDO_CORRECAO_INTERNO", 1793);
define("ESD_AGURADANDO_CORRECAO_EXTERNO", 1800);
